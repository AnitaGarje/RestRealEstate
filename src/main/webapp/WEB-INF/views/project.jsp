                                ...
                                <c:forEach var="project" items="${projectList}" varStatus="status">
                                    ...
                                    <tr class="odd gradeX">
                                      <td>${project.id}</td>
                    	                ...
                    	                <td><a href="<c:url value='/edit/${project.id}' />" ><i class="fa fa-pencil" aria-hidden="true" style="margin-left: 10px;"></i></a>
                    	                 <td><a href="<c:url value='/remove/${project.id}'/>" ><i class="fa fa-trash" aria-hidden="true" style="margin-left: 10px;"></i></a></td>
                                    </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
